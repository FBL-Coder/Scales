...
public class AppSharePreferenceMgr {
    ...
    public static synchronized void put(String key, Object object) {
        ...
        Context context = MyApp.Companion.getMApplication().getApplicationContext();
    ...
    public static synchronized Object get(String key, Object defaultObject) {
        return get(MyApp.Companion.getMApplication().getApplicationContext(), key, defaultObject);
    }
