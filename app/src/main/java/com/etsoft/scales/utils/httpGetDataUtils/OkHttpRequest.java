...
public class OkHttpRequest {
    ...
    static final String AppSecret = "b4a09a932ead8d3369161ecad916f0bb";
    static String time = "";
    static final String clientid = "c7519eaf163cfd5812bb49098552dada";
    static String sip = "";
    ...
    public static void doExecute(final Request request, HttpCallback callback) {
        try {
            ...
            if (response.isSuccessful()) {
                ...
                OkHttpUtils.sendFailResultCallback(null, request.url().toString(), response.code(), response.message(), callback);
            }
        } catch (Exception e) {
            OkHttpUtils.sendFailResultCallback(null, request.url().toString(), -1, e.getMessage(), callback);
        }
    }
...
//        }
        ...
        return builder
                .tag(tag)
                .addHeader("access-token", (String) AppSharePreferenceMgr.get(SaveKey.Companion.getACCESS_TOKEN(), ""))
                .addHeader("refresh-token", (String) AppSharePreferenceMgr.get(SaveKey.Companion.getREFRESH_TOKEN(), ""))
                .build();
    }
